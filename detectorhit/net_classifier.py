...
class CaseNet(nn.Module):
    ...
    def forward(self, xlist, coordlist):
        ...
        # print('xsize:', xsize, 'coordsize:', corrdsize)
        ...
        #         xlist: 1 x 5 x 1x 96 x 96 x 96
        #         coordlist: 1 x 5 x 3 x 24 x 24 x 24
        ...
        # print('DEBUG nodulePred: ', nodulePred)
