<template>
  <section style="padding-left: 0;padding-right: 0%">
          ...
          <el-form ref="predictForm" :model="predictForm">
            ...
            <el-col :span="6">
              <el-form-item label="原图编号:">
                <span>{{allAIcoord[page-1].split(',')[2]}}</span>
              </el-form-item>
            </el-col>
          </el-form>
        </el-row>
    ...
    <div>
      <el-row :gutter="20">
        <el-col :span="5" v-for="imageCode in allImageList" style="margin-top: 3em">
          <div style="padding: 4px;">
            <div class="demonstration">编号： {{allImageList.indexOf(imageCode)}}</div>
            <img
              v-image-preview
              :src="formatImgSrc(imageCode)"
              style="width: 20vw; height: 15vw;margin-left: auto;margin-right: auto;"
            >
          </div>
        </el-col>
      </el-row>
